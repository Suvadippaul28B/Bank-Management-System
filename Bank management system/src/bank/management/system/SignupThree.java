...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno)
    {
        ...
        JLabel services=new JLabel(" Services Requird: ");
        ...
        c4=new JCheckBox("Email & SMS alerting:");
        ...
        c7=new JCheckBox("I here by declair thet entered details are valid");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== submit){
            ...
            if(c1.isSelected()){
                ...
                facility=facility+"Email & SMS alerting";
